...
/** deletePicture POST /api2/picture/delete */
...
/** editPicture POST /api2/picture/edit */
...
/** editPictureByBatch POST /api2/picture/edit/batch */
...
/** getPictureById GET /api2/picture/get */
...
/** getPictureVOById GET /api2/picture/get/vo */
...
/** listPictureByPage POST /api2/picture/list/page */
...
/** listPictureVOByPage POST /api2/picture/list/page/vo */
...
/** listPictureVOByPageWithCacheCaffeine POST /api2/picture/list/page/vo/cacheCaffeine */
export async function listPictureVoByPageWithCacheCaffeineUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/cacheCaffeine', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOByPageWithCacheLevels POST /api2/picture/list/page/vo/cacheLevels */
export async function listPictureVoByPageWithCacheLevelsUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/cacheLevels', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOByPageWithCache POST /api2/picture/list/page/vo/cacheRedis */
export async function listPictureVoByPageWithCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/cacheRedis', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** createPictureOutPaintingTask POST /api2/picture/out_painting/create_task */
...
/** getPictureOutPaintingTask GET /api2/picture/out_painting/get_task */
...
/** doPictureReview POST /api2/picture/review */
...
/** searchPictureByColor POST /api2/picture/search/color */
...
/** searchPictureByPicture POST /api2/picture/search/picture */
...
/** searchPictureByPictureIsSo POST /api2/picture/search/picture/so */
...
/** listPictureTagCategory GET /api2/picture/tag_category */
...
/** updatePicture POST /api2/picture/update */
...
/** uploadPicture POST /api2/picture/upload */
...
/** uploadPictureByBatch POST /api2/picture/upload/batch */
...
/** uploadPictureByUrl POST /api2/picture/upload/url */
